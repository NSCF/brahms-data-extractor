...
# run extract_fields.py - creates the mysql database tables and then extracts the desired fields from the csvs created above
...
# To reconcile taxonomy see https://github.com/gitonthescene/csv-reconcile
